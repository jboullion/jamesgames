...
gulp.task('scripts', function() {
	...
	//return gulp.src([SRC_PATH+'scripts/functions.js', SRC_PATH+'scripts/Game.js'])
	return browserify({
			paths: [SRC_PATH+'scripts/functions.js', SRC_PATH+'scripts/Game.js'],
			entries: SRC_PATH+'scripts/Game.js',
			debug: true,
			transform: [
				[
					babelify, {
